...
:pencil2: 左邊是原本的，右邊是  CurrentAge 改為 >=0.8

:pencil2: 可以看到調整 rule 後， **預測錯誤的數量減少了**。`188` :point_right: `186`

![cm-auto](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_auto.png)
![cm-auto-2](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_auto-2.png)

:two: algorithm = `ball_tree`

:pencil2: 左邊是原本的，右邊是  CurrentAge 改為 >=0.8

:pencil2: 可以看到調整 rule 後， **預測錯誤的數量增加了**。`157` :point_right: `175`

![cm-balltree](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_balltree.png)
![cm-balltree-2](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_balltree-2.png)

:three: algorithm = `kd_tree`

:pencil2: 左邊是原本的，右邊是  CurrentAge 改為 >=0.8

:pencil2: 可以看到調整 rule 後， **預測錯誤的數量增加了**。`163` :point_right: `169`

![cm-kd_tree](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_kdtree.png)
![cm-kd_tree-2](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_kdtree-2.png)

:three: algorithm = `brute`

:pencil2: 左邊是原本的，右邊是  CurrentAge 改為 >=0.8

:pencil2: 可以看到調整 rule 後， **預測錯誤的數量增加了**。`182` :point_right: `187`

![cm-brute](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_brute.png)
![cm-brute-2](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_brute-2.png)

:four: 結論

更改某一個規則後 (`CurrentAge 改為 >=0.8`)，只有 algorithm="auto" 的時候，預測的結果較好

:five: 比較 Decision tree & KNN confusion matrix
...
:pencil2: 左邊是 Decision Tree，右邊是  KNN (algorithm=auto)

![cm-dt](confusion_matrix/decision_tree/confusion_matrix_dt.png)
![cm-auto](confusion_matrix/knn/confusion_matrix_knn_neighbor_5_auto.png)
